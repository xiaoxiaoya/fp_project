...
HD_PWD='D:/project/fp_project/pro_dsbjq/pro_dsbjq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log v_dsbjq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source v_dsbjq.tcl -notrace
