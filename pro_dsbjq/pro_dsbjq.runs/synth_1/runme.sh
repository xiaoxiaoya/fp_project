...
HD_PWD='D:/project/fp_project/pro_dsbjq/pro_dsbjq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log v_dsbjq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source v_dsbjq.tcl
