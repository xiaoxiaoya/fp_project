...
HD_PWD='D:/project/fp_project/add4_pro/add4_pro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add4_src.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add4_src.tcl
