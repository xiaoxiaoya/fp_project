...
HD_PWD='D:/project/fp_project/add4_pro/add4_pro.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add4_src.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add4_src.tcl -notrace
